...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/loginEmpresaStyle.css') }}"> 
    <link rel="stylesheet" href="{{ asset('mediaQuery/loginEMpresaMQ.css') }}">
    <script src="{{ asset('js/loginEmpresa.js') }}"></script>
    <title>Registro empresa</title>
</head>
<body>
    <header>
        <a href="http://127.0.0.1:8000/login/">
            <img src="../img/imagensLoginEmpresa/btnReturn.png" alt="botao para retornar">
        </a>
    </header>
    <main>
        <section class="sectionEsquerda">
            <div>
                ...
                <p>Como uma empresa você fornecerá suas StartUps para potenciais investidores e juntos iremos alavancar o seu projeto</p>
            </div>
        </section>
                ...
                <div class="containerForm">
                    ...
                    @csrf
                        ...
                        <div class="inputCNPJ">
                            ...
                            <input type="number" required name="cnpj" id="inputCNPJ" placeholder="Insira seu CNPJ" onclick="removePlaceholderCNPJ()">
                        </div>

                        <div>
                            <label for="inputOcup">Ocupação</label>
                            <input type="text" required name="area_atuacao" id="inputOcup" placeholder="Insira sua ocupação" onclick="removePlaceholderOcup()">
                        </div>
