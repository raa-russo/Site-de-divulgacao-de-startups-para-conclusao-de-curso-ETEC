    ...
    <main>
       <section class="section-esquerda">
        ...
        <div class="container-background">
            <img src="/img/li/Ayanokouji.Kiyotaka.full.3016704.png" alt="background" class="background-imagem">
        </div>
       </section>
       <section class="section-direita">
        <div class="container">
            <div class="banner-perfil">
                <img src="/img/li/Rectangle 98.png" alt="banner" class="banner">
            </div>
            <div class="icon-perfil">
                <img src="/img/li/Ellipse 36.png" alt="icon" class="icon">
            </div>
            ...
            <form action="{{url('login_investidor')}}" method="post">
                    ...
                    <div class="input-form">
                        <label>CPF:</label>
                        <input type="number" required class="input-all cpf" name="cpf">
                    </div>

                    <div class="input-form">
                        <label>RG:</label>
                        <input type="number" required class="input-all rg" name="rg">
                    </div>

                    <div class="input-form">
                        <label>Ocupação:</label>
                        <input type="number" required class="input-all ocupacao" name="ocupacao">
                    </div>
